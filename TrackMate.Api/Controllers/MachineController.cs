...
namespace TrackMate.Api.Controllers
{
    ...
    public class MachineController : ControllerBase
    {
        ...
        [HttpGet("agents/unavailable/{userName}")]
        public Task<IEnumerable<string>> GetUnavailableAgents(string userName)
        {
            return MachineService.GetUnavailableAgents(userName);
        }
        [HttpGet("count")]

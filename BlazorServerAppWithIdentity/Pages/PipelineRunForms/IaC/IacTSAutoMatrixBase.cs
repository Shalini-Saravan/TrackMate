...
{
    public class IacTSAutoMatrixBase : ComponentBase, IAsyncDisposable
    {
        [Inject]
        ...
        public void RunPipeline()
        {
            ...
            try
            {
                ...
                string jsonString = "{\"definition\":{\"id\":" + PipeLineId + "}, \"templateParameters\": {\"Instructions\" : \"" + Instructions + "\",\"Machine_Name\": \"" + Machine_Name + "\", \"Rebuild\" : \"" + Rebuild + "\"}}";

...
{
    public class IacTSDUBase : ComponentBase
    {
        [Inject]
        ...
        public string LVVersion { get; set; } = "Latest_LabView";
        ...
        public void RunPipeline()
        {
            ...
            try
            {
                ...
                string jsonString = "{\"definition\":{\"id\":" + PipeLineId + "}, \"templateParameters\": {\"Rebuild\": \"" + Rebuild + "\", \"LabViewVersion\" : \"" + LVVersion + "\"}}";

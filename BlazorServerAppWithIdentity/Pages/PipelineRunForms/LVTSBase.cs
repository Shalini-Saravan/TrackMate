...
{
    public class LVTSBase : ComponentBase, IAsyncDisposable
    {
        [Inject]
        ...
        public string minimumSupportedLV { get; set; } = "NA";

        public string FeatureToggle { get; set; } = "/allowNextRelease";
        ...
        public void RunPipeline()
        {
            ...
            try
            {
                ...
                string jsonString = "{\"definition\":{\"id\":" + PipeLineId + "}, \"templateParameters\": {\"Machine_Name\": \"" + Machine_Name + "\",\"RunSetupOnly\" :" + RunSetupOnly + ", \"Bitness\" : \"" + Bitness + "\" ,\"TSVersion\" : \"" + TSVersion + "\",\"minimumSupportedLV\": \"" + minimumSupportedLV + "\", \"FeatureToggle\" : \"" + FeatureToggle + "\"}}";
